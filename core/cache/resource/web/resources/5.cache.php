<?php  return array (
  ...
  array (
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<h1>Demonstraties</h1>
<p>Gelegen aan de rand van de Peel in het mooie (laarbeek),wordt er aan de Helmondseweg dagelijks klompen gemaakt. De ambachtelijke klompenmakerij is gevestigd in een modern pand maar van binnen heeft het de uitstraling van een echte oude klompenmakerij, museum en winkel.</p>
<p>U kunt hier terecht voor een demonstratie of gewoon even lekker rond neuzen voor een paar leuke souvenirs of klompen. Wilt u graag een demonstratie bijwonen, kunt u contact opnemen met het klompenschuurtje.</p>
<p>Daarnaast hebben wij ook verschillende arrangementen, vrijgezellenfeesten, vriend(innen) dag of familiedag.</p>
<p><strong>Demonstraties worden ook op locatie gegeven. Vraag vrijblijvend naar de voorwaarden.</strong></p>',
    'richtext' => 1,
    'template' => 14,
    'menuindex' => 4,
    'searchable' => 1,
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1303416182,
    'editedby' => 1,
    'editedon' => 1452980390,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1303416180,
    'publishedby' => 1,
    ...
    array (
      0 => 'ContentTplSidebar',
      1 => '<p><img src="media/demonstratie-1.jpg" alt="" width="600" height="525" /><img src="media/demonstratie-2.jpg" alt="" width="600" height="525" /><img src="media/demonstratie-3.jpg" alt="" width="600" height="525" /></p>',
      2 => 'default',
      3 => NULL,
      4 => 'richtext',
    ),
...
<html class="no-js" lang="">
    <head>
		...
		<title>Demonstraties van het klompen maken - Het Klompenschuurtje</title>
...
<li>
	<a href="demonstraties.html" class="active">Demonstraties</a>
</li>
<li>
...
<p><strong>Demonstraties worden ook op locatie gegeven. Vraag vrijblijvend naar de voorwaarden.</strong></p>
	...
	<aside>
	    <p><p><img src="media/demonstratie-1.jpg" alt="" width="600" height="525" /><img src="media/demonstratie-2.jpg" alt="" width="600" height="525" /><img src="media/demonstratie-3.jpg" alt="" width="600" height="525" /></p></p>
	</aside>
</div>
			</main>
...
<li>
    ...
    '[[*ContentTplSidebar?]]' => '<p><img src="media/demonstratie-1.jpg" alt="" width="600" height="525" /><img src="media/demonstratie-2.jpg" alt="" width="600" height="525" /><img src="media/demonstratie-3.jpg" alt="" width="600" height="525" /></p>',
    '[[$Footer? ]]' => '			</main>
