<?php  return array (
  ...
  'formit.email_invalid' => 'Vul aub een geldig e-mailadres in.',
  'formit.email_invalid_domain' => 'Het opgegeven e-mailadres is niet geldig.',
  'formit.email_no_recipient' => 'Please specify a recipient or recipients for the email.',
  'formit.email_not_sent' => 'Er is een fout opgetreden bij het versturen van de e-mail.',
  'formit.email_tpl_nf' => 'Please specify an email template.',
  'formit.field_not_empty' => 'This field must be empty.',
  'formit.field_required' => 'Dit is een verplicht veld.',
